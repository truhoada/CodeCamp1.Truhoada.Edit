...
- (void) animateCowEatGrass {
    ...
    [tapCow setNumberOfTapsRequired:1]; //Set Number of Touches Required
...
- (void) animateDutchLady {
    dutchLady = [[UIImageView alloc]initWithFrame:CGRectMake(self.view.bounds.size.width/3, self.view.bounds.size.height-100, 100, 125)];
//    dutchLadyReturn = [[UIImageView alloc]initWithFrame:CGRectMake(self.view.bounds.size.width-200, self.view.bounds.size.height-100, 100, 125)];
    ...
    dutchLady.center = CGPointMake(self.view.bounds.size.width/3, self.view.bounds.size.height-100);
//    dutchLadyReturn.center = CGPointMake(self.view.bounds.size.width+45, self.view.bounds.size.height-100);
    ...
    [tapDutchLady setNumberOfTapsRequired:1]; //Set Number of Tap Required (Tap: so lan tap (nhu Click); Touch: So lan cham: 2 ngon tay cham: touch = 2
    [dutchLady addGestureRecognizer:tapDutchLady];
//    [dutchLady setMultipleTouchEnabled:1];
...
- (void) animateDutchLadyMove {
    ...
    [UIView animateWithDuration:4 animations:^{
        dutchLady.center = CGPointMake(self.view.bounds.size.width-50, self.view.bounds.size.height-100);
        
    } completion:^(BOOL finished) {
        dutchLady.transform = CGAffineTransformConcat(
                                                      CGAffineTransformMakeScale(-1, 1),
                                                      CGAffineTransformMakeRotation(2*M_PI));
        [UIView animateWithDuration:4 animations:^{
            dutchLady.center = CGPointMake(self.view.bounds.size.width/4, self.view.bounds.size.height-100);
...
//    for (UIImageView *dutchLadyImage in dutchLady)
//    {
//        if ([dutchLadyImage.layer.presentationLayer hitTest:touchLocation])
//        {
//            // This UIImageView was hit whilst moving - do something with it here
//            break;
//        }
//    }
//}
